...
<!-- 组合查询form表单 -->
	<div id="form_kaoqin" title="组合查询" class="easyui-panel"
		data-options="iconCls:'icon-search',href:'${pageContext.request.contextPath}/queryForm/employee/kaoqin_queryform.jsp',collapsible:true,tools:[
		...
		<table id="datagrid_kaoqin" class="easyui-datagrid" style="width:100%;height:489px;"
			...
			<thead>
				<tr>
					...
					<th data-options="field:'chuqinDay',width:40,sortable:true,editor:{type:'numberbox',options:{required:true}}">出勤天数</th>
					<th data-options="field:'zhuanzhengChaeDay',width:40,sortable:true,editor:{type:'numberbox',options:{required:true}}">转正差额天数</th>
					<th data-options="field:'chidaoYingkouDay',width:40,sortable:true,editor:{type:'numberbox',options:{required:true}}">迟到应扣天数</th>
					<th data-options="field:'shiJiaHour',width:40,sortable:true,editor:{type:'numberbox',options:{required:true}}">事假时数</th>
					<th data-options="field:'bingJiaHour',width:40,sortable:true,editor:{type:'numberbox',options:{required:true}}">病假时数</th>
					<th data-options="field:'kuangGongHour',width:40,sortable:true,editor:{type:'numberbox',options:{required:true}}">旷工时数</th>
					<th data-options="field:'hunJiaDay',width:40,sortable:true,editor:{type:'numberbox',options:{required:true}}">婚假天数</th>
					<th data-options="field:'chanJiaDay',width:40,sortable:true,editor:{type:'numberbox',options:{required:true}}">产假天数</th>
					<th data-options="field:'sangJiaDay',width:40,sortable:true,editor:{type:'numberbox',options:{required:true}}">丧假天数</th>
					<th data-options="field:'nianJiaDay',width:40,sortable:true,editor:{type:'numberbox',options:{required:true}}">年假天数</th>
