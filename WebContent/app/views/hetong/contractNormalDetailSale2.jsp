		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
		  ...
		  <tr>
			...
			<td valign="top">
				...
				<input  id="contractAmount" type="text" autocomplete="off" name="textfield"  class="fidtext" value="${contract.contractMoney }" onBlur="validateContractAmount();"/>
		  ...
		  <tr>
			<td valign="top">
				...
				<input id="contractCount" type="text" autocomplete="off" name="textfield" class="fidtext" value="${contract.agreementNumber }"/>
...
<script type="text/javascript" src="/app/views/hetong/js/contractNormalDetailSale2.js"></script>
<script type="text/javascript" src="/app/views/hetong/My97DatePicker/WdatePicker.js"></script>
<script type="text/javascript">
/* 要放到saleCommon.js后 ,等$('select').selectlist方法执行完后赋值*/
$(function(){
	$("input[name='danwei']").val('${contract.cid}');
